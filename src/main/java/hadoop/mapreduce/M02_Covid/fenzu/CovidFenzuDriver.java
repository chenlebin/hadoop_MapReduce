 ...
 * @return
 */
public class CovidFenzuDriver extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception{
        ...
        int status = ToolRunner.run(conf, new CovidFenzuDriver(),args);
        //退出客户端
        System.exit(status);
    }
    ...
    public int run(String[] args) throws Exception{
        //构建Job作业的实例
        Job job=Job.getInstance(getConf(), CovidFenzuDriver.class.getSimpleName());

        //TODO 设置job属性
        //设置MapReduce程序
        job.setJarByClass(CovidFenzuDriver.class);

        //设置本次MapReduce程序的mapper类Reduce类
        job.setMapperClass(CovidFenzuMapper.class);
        job.setReducerClass(CovidFenzuReducer.class);
        ...
        */
        ...
        //TODO 指定分组规则：
        job.setGroupingComparatorClass(CovidFenzuComparator.class);
