 ...
 * @return
 */
public class CovidDaoxuDriver extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception{
        ...
        int status = ToolRunner.run(conf, new CovidDaoxuDriver(),args);
        //退出客户端
        System.exit(status);
    }
    ...
    public int run(String[] args) throws Exception{
        //构建Job作业的实例
        Job job=Job.getInstance(getConf(), CovidDaoxuDriver.class.getSimpleName());

        //TODO 设置job属性
        //设置MapReduce程序
        job.setJarByClass(CovidDaoxuDriver.class);

        //设置本次MapReduce程序的mapper类Reduce类
        job.setMapperClass(CovidDaoxuMapper.class);
        job.setReducerClass(CovidDaoxuReducer.class);
        ...
        */
        ...
        job.setMapOutputKeyClass(CovidDaoxuBean.class);
        ...
        */
        ...
        job.setOutputValueClass(CovidDaoxuBean.class);
