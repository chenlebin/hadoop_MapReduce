 ...
 */
public class CovidDaoxuBean implements WritableComparable<CovidDaoxuBean> {
    private long cases;//确诊病例数
    private long deaths;//死亡病例数

    //有参构造
    public CovidDaoxuBean(long cases, long deaths) {
        this.cases = cases;
        this.deaths = deaths;
    }

    //无参构造
    public CovidDaoxuBean() {
    ...
    /**
     * @author: Suofen
     * description: TODO 重写排序方法
     *                   规则：
     *                   0：相等  1：大于  -1：小于
     * create time: TODO 2021/10/4 10:57
     *
     * @Param: o
     * @return int
     */
    public int compareTo(CovidDaoxuBean o) {
        if (this.cases>o.getCases())
            return -1;
        else if(this.cases<o.getCases())
            return 1;
        else
            return 0;
    }
