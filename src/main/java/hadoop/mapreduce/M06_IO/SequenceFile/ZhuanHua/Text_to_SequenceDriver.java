 ...
 * @return
*/
public class Text_to_SequenceDriver extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception{
        ...
        int status = ToolRunner.run(conf, new Text_to_SequenceDriver(),args);
        //退出客户端
        System.exit(status);
    }
    ...
    public int run(String[] args) throws Exception{
        //构建Job作业的实例
        Job job=Job.getInstance(getConf(), Text_to_SequenceDriver.class.getSimpleName());

        //TODO 设置job属性
        //设置MapReduce程序
        job.setJarByClass(Text_to_SequenceDriver.class);
        ...
        //TODO 设置SequenceFile文件的压缩格式为：BLOCK
