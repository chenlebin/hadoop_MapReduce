 ...
 * @return
*/
public class WordCountJiShuQiDriver extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception{
        ...
        int status = ToolRunner.run(conf, new WordCountJiShuQiDriver(),args);
        //退出客户端
        System.exit(status);
    }
    ...
    public int run(String[] args) throws Exception{
        //构建Job作业的实例
        Job job=Job.getInstance(getConf(), WordCountJiShuQiDriver.class.getSimpleName());

        //TODO 设置job属性
        //设置MapReduce程序
        job.setJarByClass(WordCountJiShuQiDriver.class);
