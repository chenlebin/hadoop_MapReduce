...
public class ReadDBMapper extends Mapper<LongWritable, usa_zongBean, NullWritable, Text> {
    //LongWritable outkey = new LongWritable();
    Text outvalue = new Text();
    @Override
    protected void map(LongWritable key, usa_zongBean value, Context context) throws IOException, InterruptedException {
        //其实就是将数据原封不动的写出去
        //outkey.set(key.get());
