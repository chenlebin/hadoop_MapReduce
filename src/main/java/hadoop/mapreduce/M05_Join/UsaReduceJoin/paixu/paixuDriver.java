...
import hadoop.mapreduce.M05_Join.UsaReduceJoin.usa_scOut.OutScCompartor;
 ...
 * @return
 */
public class paixuDriver extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception{
        ...
        int status = ToolRunner.run(conf, new paixuDriver(),args);
        //退出客户端
        System.exit(status);
    }
    ...
    public int run(String[] args) throws Exception{
        //构建Job作业的实例
        Job job=Job.getInstance(getConf(), paixuDriver.class.getSimpleName());
        ...
        */
        ...
        job.setMapOutputKeyClass(UsaScBean.class);
        ...
        */
        ...
        job.setOutputKeyClass(UsaScBean.class);
        ...
        //TODO 指定分组规则：
        job.setGroupingComparatorClass(OutScCompartor.class);
