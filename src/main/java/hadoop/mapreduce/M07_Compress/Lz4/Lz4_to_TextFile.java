...
/**
 * @author: Suofen
 * description: TODO Gzip压缩文件转化为普通文本文件
 * create time: TODO 2021/10/20 18:37
 *
  * @Param: null
 * @return
 */
public class Lz4_to_TextFile extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception{
        ...
        int status = ToolRunner.run(conf, new Lz4_to_TextFile(),args);
        //退出客户端
        System.exit(status);
    }
    ...
    public int run(String[] args) throws Exception {
        //构建Job作业的实例
        Job job = Job.getInstance(this.getConf(), Lz4_to_TextFile.class.getSimpleName());

        //TODO 设置job属性
        //设置MapReduce程序
        job.setJarByClass(Lz4_to_TextFile.class);
